...
.method retrieveEphemeralKey(Ljava/lang/String;Ljava/util/Map;)V
    ...
    new-instance v1, Lcom/stripe/android/EphemeralKeyManager$ClientKeyUpdateListener;

    invoke-direct {v1, p0, p1, p2}, Lcom/stripe/android/EphemeralKeyManager$ClientKeyUpdateListener;-><init>(Lcom/stripe/android/EphemeralKeyManager;Ljava/lang/String;Ljava/util/Map;)V

    const-string p1, "2017-06-05"

    invoke-interface {v0, p1, v1}, Lcom/stripe/android/EphemeralKeyProvider;->createEphemeralKey(Ljava/lang/String;Lcom/stripe/android/EphemeralKeyUpdateListener;)V
